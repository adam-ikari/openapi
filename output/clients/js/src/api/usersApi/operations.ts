...
export function _$deleteSend(
  context: Client,
  id: string,
  options: UsersApiDeleteOptionalParams = { requestOptions: {} },
): StreamableMethod {
...
export function _updateSend(
  ...
  id: string,
  body: User,
  options: UsersApiUpdateOptionalParams = { requestOptions: {} },
): StreamableMethod {
  const path = expandUrlTemplate(
    "/api/v2/users/{id}",
    {
...
export function _createSend(
  context: Client,
  body: User,
  options: UsersApiCreateOptionalParams = { requestOptions: {} },
): StreamableMethod {
  return context
    .path("/api/v2/users")
    .post({
...
export function _readSend(
  context: Client,
  id: string,
  options: UsersApiReadOptionalParams = { requestOptions: {} },
): StreamableMethod {
  const path = expandUrlTemplate(
    "/api/v2/users/{id}",
    {
